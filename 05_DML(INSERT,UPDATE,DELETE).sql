...
CREATE TABLE EMP_01( -- 서브쿼리?
		EMP_ID NUMBER,
		EMP_NAME VARCHAR2(30),
		DEPT_TITLE VARCHAR2(20)
		
); -- 테이블만 만들었지 이 테이블 안에 데이터 인서트 안함
...
UPDATE EMPLOYEE2
SET BONUS = 0.1
WHERE BONUS IS NULL; -- SELECT * FROM EMPLOYEE2; 를 조회했을 때
-- 						BONUS가 NULL인 애들만 0.1로 변경 한다는 코드
-- 총 15개 행 수정
