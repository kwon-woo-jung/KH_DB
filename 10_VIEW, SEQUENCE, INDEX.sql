...
--> OR REPLACE 옵션을 사용해봄
CREATE OR REPLACE VIEW VIEW V_EMP
AS 
SELECT EMP_ID 사번,
EMP_NAME 이름, 
...
LEFT JOIN KH_KWJ.DEPARTMENT ON (DEPT_CODE = DEPT_ID)
ORDER BY 사번 ASC;
...
-- ORQ-08002: 시퀀스 SEQ_TEST_NO.CURRVAL은 이 세션에서는 정의 되어 있지 않습니다
...
-- SEQ_TEST_NO 의 MAXVALYE 값을 200 으로 수정
...
-- SEQ_TEST_NO_SEQUENCE 삭제
DROP SEQUENCW SEQ_TEST_NO;
