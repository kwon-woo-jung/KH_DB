...
-- 기본키 NULL 이므로 오류!
-- SQL Error [1400] [23000]: ORA-01400: NULL을 ("KH_CMH"."USER_USED_PK"."USER_NO") 안에 삽입할 수 없습니다
...
INSERT INTO USER_USED_PK2
VALUES (1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
-- SQL Error [1] [23000]: ORA-00001: 무결성 제약 조건(KH_CMH.PK_USERNO_USERID)에 위배됩니다
...
-- SQL Error [1400] [23000]: ORA-01400: NULL을 ("KH_CMH"."USER_USED_PK2"."USER_NO") 안에 삽입할 수 없습니다

INSERT INTO USER_USED_PK2
VALUES (3, NULL, 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
-- SQL Error [1400] [23000]: ORA-01400: NULL을 ("KH_CMH"."USER_USED_PK2"."USER_ID") 안에 삽입할 수 없습니다
...
--> ON DELETE SET NULL 옵션이 설정되어있어서 오류 없이 삭제됨
...
VALUES (1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
-- SQL Error [2290] [23000]: ORA-02290: 체크 제약조건(KH_CMH.GENDER_CHECK)이 위배되었습니다
